// src/components/ui/confirmation-modal/ConfirmationModal.tsx
    ...
    >
      <div className="text-center">
        ...
        <div className="flex items-center justify-center w-full gap-4 mt-7">
          ...
          <button
            type="button"
            className={`flex justify-center px-4 py-3 text-sm font-medium text-white rounded-lg shadow-theme-xs ${styles.buttonClass}`}
            onClick={onConfirm}
          >
            {confirmText}
          </button>
