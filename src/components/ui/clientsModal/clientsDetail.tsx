...
// import { formatPhoneNumber, formatFileSize, formatPrice} from "../../formatters/index";

// // Add console logs to help debug
// console.log("ClientDetails component is being loaded");
...
//   //   return `${formatPrice} PLN`;
//   // };
  
//   const formatDate = (dateString: string): string => {
//     return new Date(dateString).toLocaleDateString();
//   };
//   // Add debugging log right before rendering
...
//       <div className="bg-white dark:bg-white/[0.03] p-6 rounded-xl shadow-sm border border-gray-200 dark:border-white/[0.05]">
...
//                   />
//                 ) : (
//                   <p className="mt-1 text-gray-800 dark:text-white/90 font-semibold text-lime-500">
...
//             <h2 className="text-lg font-semibold text-gray-800 dark:text-white/90">Dokumenty klienta</h2>
//             <div>
//               <input
//                 key={fileInputKey}
//                 type="file"
...
//               <Button size="sm" variant="outline" onClick={() => document.getElementById('fileUpload').click()}
//               >
//                 <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
//                 </svg>
